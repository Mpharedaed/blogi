...
export default {
  ...
  methods: {
    ...
    async search() {
      fetch(`https://blogi-36jo.onrender.com/api/search`, {
        method: "POST",
        mode: "cors",
        headers: {
    ...
    async follow(user) {
      this.success = null;
      this.error = null;
      const res = await fetch(`https://blogi-36jo.onrender.com/api/follow`, {
        method: "POST",
        mode: "cors",
        headers: {
          "Content-Type": "application/json",
    ...
    async unfollow(user) {
      ...
      // console.log(c);
      const res = await fetch(`https://blogi-36jo.onrender.com/api/unfollow`, {
        method: "POST",
        mode: "cors",
        headers: {
          "Content-Type": "application/json",
