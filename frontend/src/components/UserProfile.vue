...
export default {
  ...
  async created() {
    ...
    //   this.$router.push("/");
    // }
    return fetch(`https://blogi-36jo.onrender.com/api/profile/${this.username}`, {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  methods: {
    ...
    async del(id) {
      ...
      if (confirm("Want to delete this Blog !!")) {
        const res = await fetch(`https://blogi-36jo.onrender.com/api/blog/${id}`, {
          method: "DELETE",
          mode: "cors",
          headers: {
            "Content-Type": "application/json",
    ...
    async exporting() {
      const res = await fetch(`https://blogi-36jo.onrender.com/api/exportblogs`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "Authentication-Token": `${this.auth_token}`,
