<template>
  <div class="all">
    ...
    <div class="postBlog">
      <form
        action="https://blogi-36jo.onrender.com/postblog"
...
export default {
  ...
  async created() {
    ...
    return fetch(`https://blogi-36jo.onrender.com/api/blog/${this.bgid}`, {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  methods: {
    ...
    async postBlog() {
      ...
      try {
        const res = await fetch(`https://blogi-36jo.onrender.com/api/blog/${this.bgid}`, {
          mode: "cors",
          method: "PuT",
          headers: {
            "Access-Control-Allow-Origin": "*",
